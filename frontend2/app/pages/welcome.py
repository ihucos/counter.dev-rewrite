...
with t.html(lang="en"):
    ...
    with t.body:
        with t.header:
            t.element("counter-flash")
            t.element("base-navbar")
        ...
        with t.section(klass="welcome"):
            with t.div(klass="content"):
                ...
                with t.div(klass="welcome-text"):
                    ...
                    # Item
                    with t.div(
                        klass="welcome-features-item flex bg-white radius-sm mb16"
                    ):
                        t.img(
                            src="/img/free-sm.svg",
                            width="24",
                ...
                with t.div(klass="welcome-form bg-white radius-sm shadow-lg tabs"):
                    ...
                    with t.div(id="sign-up"):
                        with t.form(action="/register", method="POST"):
                            ...
                            t.button(
                                "Sign up", type="submit", klass="btn-secondary mt24"
                            )
        ...
        with t.div(id="modal-recover", style="display: none"):
            with t.div(klass="modal-header"):
                t.img(
                    src="/img/account.svg", width="24", height="24", alt="Edit account"
                )
